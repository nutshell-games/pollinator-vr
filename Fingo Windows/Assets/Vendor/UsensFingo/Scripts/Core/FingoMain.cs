...
namespace Fingo 
{
    ...
    public class FingoMain : Singleton <FingoMain>
    {
        ...
        void Awake()
        {
            if (FingoManager.Instance.Initialize(this,enableHandTracking, enableControllerTracking, enableGestureDetection, enableInfraredImage, enableColorImage, enableHeadTracking))
            {
        ...
        {
            if (FingoManager.Instance.ReleaseAllDevices())
            {
