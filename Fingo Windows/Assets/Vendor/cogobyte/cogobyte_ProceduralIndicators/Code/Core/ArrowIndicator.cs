        ...
        public override void generate()
        {
            ...
            else
            {
                ...
                if (arrowPath.arrowPathMode == ArrowPath.ArrowPathMode.MadeOfShapes)
                {
                    ...
                    arrowPath.GenerateMadeOfShapes(vertices, triangles);
            ...
            else
            {
                if (arrowPath.arrowTail.arrowTipMode == ArrowTip.ArrowTipMode.Mesh)
                {
                    ...
                    arrowPath.arrowTail.generateMesh(vertices, triangles);
                }
            }
            ...
            else
            {
                if (arrowPath.arrowHead.arrowTipMode == ArrowTip.ArrowTipMode.Mesh)
                {
                    ...
                    arrowPath.arrowHead.generateMesh(vertices, triangles);
                }
            }
            ...
            if (extrudeLength != 0)
            {
                ...
                //Set default values
                extrudeObject = ScriptableObject.CreateInstance<ComplexExtrude>();
