...
namespace Cogobyte.ProceduralLibrary
{
    ...
    public class ComplexExtrude : SolidMesh
    {
        ...
        private void generateOutlineVertices(int polyIndex)
        {
        ...
        private void generateShapeVertices(int polyIndex, bool startShape)
        {
        ...
        private void extrudeOnePart(int polyIndex)
        {
